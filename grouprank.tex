...
\documentclass{elsarticlenonatbib}
...
%% These options are designed to simulate the default natbib style.
\usepackage[
  natbib=true,
  backend=biber,
  isbn=false,
...
\begin{frontmatter}
  ...
  \auth[j]{Jeffrey~Finkelstein}
  \ead{jeffreyf@bu.edu}
  \address[j]{Boston University \\ Computer Science Department \\ 111 Cummington Mall \\ Boston, MA 02215 \\ +\oldstylenums{1} (\oldstylenums{617}) \oldstylenums{353 8919}}
