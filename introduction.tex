...
%% \autoref{tab:summary} summarizes these improvements, and
The inclusion diagram at right demonstrates graphically why these improvements are so significant.
