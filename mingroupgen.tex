...
\begin{figure}
\caption{A summary of the upper bounds due to this work for the problem of computing the size of the minimum generating set of a group of a given class of groups.\label{fig:results}}
  \begin{center}
    \begin{tabular}{l | l}
...
\begin{lemma}\label{lem:log}
  If $G$ is a finite group of order $n$ then the size of the minimum generating set is at most $\log n$.
\end{lemma}
\begin{todo}
